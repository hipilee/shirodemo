...
public class BaseServiceImpl implements BaseService {
    ...
    public Map<String, Object> queryInfoByTelphone(String username) {
        return userMapper.queryInfoByTelphone(username);
    }

    @Override
    public boolean registerUser(String telphone, String user_name, String password) {
        ...
        * */
        ...
        // 看数据库中是否存在该账户
        Map<String, Object> userInfo = queryInfoByTelphone(user_name);
        if(userInfo == null) {
